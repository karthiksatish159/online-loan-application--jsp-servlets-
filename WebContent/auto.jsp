...
%>	
            ...
            <div class="two-thirds">
                <div>
                    ...
                    <a href="autoinfo.html"><span class="notify"><i class="fas fa-bell icon"></i></span></a>
                            ...
                            <div id="apply-loan" class="paneluser activerUserPanel">
                                <div class="form-container loan">
                                    <form action="LoanP" method="post" name="f1">
                                        ...
                                        <input type="submit" value="applyloan" class="btn-form"  onclick="return checkform('<%=name%>')"></input>
                                    </form>
                                </div>
                            </div>
